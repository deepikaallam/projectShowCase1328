...
class App extends Component {
  state = {data: [], ap: apiStatusConstant.initial, sel: 'ALL'}
  ...
  getData = async () => {
    this.setState({ap: apiStatusConstant.loading})
    ...
    if (response.ok === true) {
      ...
      this.setState({data: updateData, ap: apiStatusConstant.success})
    } else {
      this.setState({ap: apiStatusConstant.fail})
    }
  }
